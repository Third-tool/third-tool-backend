 ...
 *
 * <p>presentation.dto.Request가 application 레이어로 새지 않도록 Controller에서 본 record로
 * 명시적 변환해 Service에 전달한다. 모든 Command는 path/auth 값을 필드로 포함하며,
...
public final class LearningFacadeCommand {
     ...
     * 위한 플래그다. Controller가 {@link com.example.thirdtool.LearningFacade.presentation.dto.LearningFacadeRequest.UpdateTopic}의
     * setter 추적 플래그를 본 record로 옮긴다.
     */
