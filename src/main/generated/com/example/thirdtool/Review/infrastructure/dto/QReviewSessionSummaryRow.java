...
public class QReviewSessionSummaryRow extends ConstructorExpression<ReviewSessionSummaryRow> {
    ...
    public QReviewSessionSummaryRow(com.querydsl.core.types.Expression<Long> sessionId, com.querydsl.core.types.Expression<Long> deckId, com.querydsl.core.types.Expression<String> deckName, com.querydsl.core.types.Expression<Integer> totalCardCount, com.querydsl.core.types.Expression<Integer> availableCardCount, com.querydsl.core.types.Expression<java.time.LocalDateTime> startedAt) {
        super(ReviewSessionSummaryRow.class, new Class<?>[]{long.class, long.class, String.class, int.class, int.class, java.time.LocalDateTime.class}, sessionId, deckId, deckName, totalCardCount, availableCardCount, startedAt);
    }
