...
- **`{NNN}`**: Epic 번호 3자리 zero-pad. `private-docs/workflows/Epic/Epic-{NNN}.md` 파일명에서 추출.
...
```
1. 현재 Epic 식별 (private-docs/workflows/Epic/Epic-{NNN}.md 파일명 + 본문).
...
- Epic 문서: `private-docs/workflows/Epic/Epic-{NNN}.md`
- 포함된 Story 문서:
  - `private-docs/workflows/story/Story-{NNN}-1.md`
  - `private-docs/workflows/story/Story-{NNN}-2.md`
  - ...
