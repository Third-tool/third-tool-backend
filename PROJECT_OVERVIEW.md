...
> 패키지 구조 규칙과 의존 방향은 [`docs/architecture/package-structure-guide.md`](docs/architecture/package-structure-guide.md)에 상세히 정의되어 있습니다. 아키텍처 의사결정은 [`docs/architecture/adr/ADR001.md`](update-docs/adr/ADR001.md)를 참고하세요.
